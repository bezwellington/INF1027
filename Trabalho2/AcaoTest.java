...
public class AcaoTest extends TestCase {
	...
	public void testAcaoVolumeMedio() {
		...
		assertEquals("O volume médio deve ser 23024148.0", Math.round(23024148.0) , Math.round(volumeMedio));
		
		Double volumeMedioMGLU3=  acaoMGLU3.getVolumeMedio();
		assertEquals("O volume médio deve ser 0", Math.round(0.0) , Math.round(volumeMedioMGLU3));
	}	
}
